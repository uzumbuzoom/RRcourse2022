...
## Display modes | Edyta's own subtitle
...
## Manipulating the presentation size {.smaller .build data-background=img/SUCCESS.png }
...
<div class="notes">Edyty notatki!!!</div>

<div class="red">Edyta dodaje kolorowe linijki!!</div>
